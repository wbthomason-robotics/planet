(define (problem pb7)
 ...
 (:objects
  ...
  bs1 bs2 bs3 bs4 bs5 bs6 gs1 gs2 gs3 gs4 gs5 gs6 -objs )
 (:init
  ...
  (on-surface bs4 table2) (on-surface bs5 table2) (on-surface bs6 table2)
  (on-surface gs5 table2) (on-surface gs6 table2)
 ...
 (:goal (and
         ...
         (on-surface bs5 table3) (on-surface bs6 table3) 
         (on-surface gs1 table4) (on-surface gs2 table4) (on-surface gs3 table4) (on-surface gs4 table4)
         (on-surface gs5 table4) (on-surface gs6 table4) (arm-empty rgrippertoolframe) (arm-empty lgrippertoolframe))))
