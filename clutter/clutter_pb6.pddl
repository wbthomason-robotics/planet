(define (problem pb7)
 ...
 (:goal (and
         (on-surface bs1 table3) (on-surface bs2 table3) (on-surface bs3 table3)
         (on-surface gs1 table4) (on-surface gs2 table4) (on-surface gs3 table4) 
