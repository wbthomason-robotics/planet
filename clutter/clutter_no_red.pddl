(define (problem pb7)
 ...
 (:objects
  ...
  bs1 bs2 bs3 bs4 bs5 bs6 bs7 gs1 gs2 gs3 gs4 gs5 gs6 gs7 -objs )
 (:init
 ...
 (:goal (and
         ...
         (on-surface gs5 table4) (on-surface gs6 table4) (on-surface gs7 table4) (arm-empty rgrippertoolframe) (arm-empty lgrippertoolframe))))
